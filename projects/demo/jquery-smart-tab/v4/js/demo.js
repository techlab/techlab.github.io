...
const cssColors = [ 
  "--st-border-color",
  "--st-toolbar-btn-color",
  "--st-toolbar-btn-background-color",
  ...
  "--st-anchor-done-primary-color",
  "--st-anchor-done-secondary-color",
  "--st-anchor-disabled-primary-color",
  "--st-anchor-disabled-secondary-color",
  "--st-anchor-anchor-error-primary-color",
  "--st-anchor-anchor-error-secondary-color",
  "--st-anchor-anchor-warning-primary-color",
  "--st-anchor-anchor-warning-secondary-color",
  "--st-progress-color",
  "--st-progress-background-color",
  "--st-loader-color",
...
$(function() {
    ...
    $("#btn-go-to").on("click", function() {
        ...
        $('#smarttab').smartTab("goToStep", step_index);
        return true;
    });
